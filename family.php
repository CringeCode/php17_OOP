<?php
    ...
    $family = new Family('Петров', 'Москва');
    $father = new Father('Василий', 32, 'Мария', $family, 'Голубые', 'Черные');
    $mother = new Mother('Мария', 35, 'Василий', $family, 'Зеленые', 'Рыжие');
    $daughter = new Child('Ольга', 9, 'Female', $father, $mother, $family);
    $son = new Child('Иван', 5, 'Male', $father, $mother, $family);
